...
class ToolFacade:
    ...
    def call(self, func_name: str, *args, **kwargs) -> Any:
        ...
        if self._fsm is None and getattr(self.context, "active_action", None) is None:
            if func_name in ("nagato_edit", "nagato_edit_lines", "nagato_delete", "nagato_concept_create", "nagato_concept_link", "nagato_concept_collapse", "nagato_concept_expand", "nagato_block_save", "nagato_block_delete", "nagato_insight_promote_to_global", "nagato_log_event", "nagato_register_algorithm", "nagato_register_protocol", "nagato_link_implementation"):
                try:
